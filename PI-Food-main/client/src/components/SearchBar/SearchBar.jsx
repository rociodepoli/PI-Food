...
import { cleanRecipes, filterDiet, getAllRecipes, getDiets, getRecipesByName, orderByName, orderByScore} from "../../actions/actions";
  ...
  return (
    <>
      <div>
        ...
        <div>
        <select id='ordername' name='name' defaultValue={props.order.name} onChange={(e)=> orderHandler(e)}>
        ...
        <div>
        <select id='orderscore' name='score' defaultValue={props.order.score} onChange={(e)=> orderHandler(e)}>
        ...
        <div>
          <select name="filter" id="filterdiets" defaultValue={'default'}onChange={(e)=>filterHandler(e)}>
